...
export function normalizeModelFields(schema: RecordSchema, properties: ModelFields): UninitializedRecord {
...
function assignKeys(modelDefinition: ModelDefinition, record: UninitializedRecord, properties: ModelFields) {
...
function assignAttributes(modelDefinition: ModelDefinition, record: UninitializedRecord, properties: ModelFields) {
...
function assignRelationships(modelDefinition: ModelDefinition, record: UninitializedRecord, properties: ModelFields) {
    ...
    if (relationshipDefs) {
        for (let relationship of Object.keys(relationshipDefs)) {
            if (properties[relationship] !== undefined) {
                let relationshipDef = relationshipDefs[relationship] as RelationshipDefinition;
