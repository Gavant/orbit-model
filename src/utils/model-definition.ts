import { AttributeDefinition, KeyDefinition, ModelDefinition, RelationshipDefinition } from '@orbit/records';
...
export function extendModelDefinition(proto: any, modelDefinition: ModelDefinition): void {
...
export function defineAttribute(proto: object, name: string, options: AttributeDefinition): void {
    extendModelDefinition(proto, {
        attributes: { [name]: options },
    });
}

export function defineKey(proto: object, name: string, options: KeyDefinition): void {
    extendModelDefinition(proto, {
        keys: { [name]: options },
    });
}

export function defineRelationship(proto: object, name: string, options: RelationshipDefinition): void {
    extendModelDefinition(proto, {
