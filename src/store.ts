...
export default class Store {
    ...
    merge<RequestData extends RecordTransformResult<Model> = RecordTransformResult<Model>>(
        forkedStore: Store,
    ...
    async merge<RequestData extends RecordTransformResult<Model> = RecordTransformResult<Model>>(
        forkedStore: Store,
        options?: RequestOptions & MemorySourceMergeOptions,
    ): Promise<RequestData | FullResponse<RequestData, unknown, RecordOperation>> {
        if (options?.fullResponse) {
            let response = (await this.source.merge(
                forkedStore.source,
                options as FullRequestOptions<RequestOptions> & MemorySourceMergeOptions,
            )) as FullResponse<RecordTransformResult<InitializedRecord>, unknown, RecordOperation>;
            ...
            let response = (await this.source.merge(
                forkedStore.source,
                options as DefaultRequestOptions<RequestOptions> & MemorySourceMergeOptions,
    ...
    async query<RequestData extends RecordQueryResult<Model> = RecordQueryResult<Model>>(
    ...
    async query<RequestData extends RecordQueryResult<Model> = RecordQueryResult<Model>>(
        ...
        id?: string,
    ): Promise<RequestData | FullResponse<RequestData, undefined, RecordOperation>>;
    async query<RequestData extends RecordQueryResult<Model> = RecordQueryResult<Model>>(
        queryOrExpressions: ModelAwareQueryOrExpressions,
    ...
    buildQueryForPagination(
        queryOrExpressions: ModelAwareQueryOrExpressions,
        options?: DefaultRequestOptions<RecordCacheQueryOptions>,
        id?: string,
    ): Query<FindRecord | FindRelatedRecord | FindRelatedRecords | FindRecords> {
        return buildQuery(queryOrExpressions, options, id, this.source.queryBuilder);
    }
    ...
    async findRecord<RequestData extends RecordQueryResult<Model> = Model | undefined>(
    ...
    async findRecords<RequestData extends RecordQueryResult<Model> = Model[]>(
        ...
        return await this.query<RequestData>(q => q.findRecords(typeOrIdentities), options);
    }
    ...
    async update<RequestData extends RecordTransformResult<Model> = RecordTransformResult<Model>>(
        transformOrOperations: ModelAwareTransformOrOperations,
        options?: RequestOptions,
        id?: string,
    ): Promise<RequestData | FullResponse<RequestData, unknown, RecordOperation>> {
